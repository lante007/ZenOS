...
async function recordOutcome(tenantSlug, o) {
  ...
  const res = await q(`
    INSERT INTO public.intelligence_outcomes
      (tenant_id, job_id, decision_id, recommendation_summary, decision_taken,
       outcome_status, outcome_description, signal_proved_reliable, recorded_by, notes)
  ...
  `, [
    ...
    o.recorded_by || null, o.notes || null,
  ]);
...
module.exports = { recordOutcome, listOutcomes, sourceReliabilityStats, OUTCOME_STATUS };
